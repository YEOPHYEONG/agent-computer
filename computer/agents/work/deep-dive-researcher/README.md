...
When a serious run creates a durable report, strategy memo, market analysis, or web-report source document, include `report-composer` as the final specialist role. It drafts the report from all same-project research artifacts and subagent findings; the Research Director reviews and accepts the final report.
