...
8. Prepare the runtime subagent plan:
   ...
   - write `subagent-orchestration.md` with execution order, stop gates, and truthfulness rules
...
25. Before final synthesis, write the question-to-synthesis trace:
   ...
   - Next-Best Question
26. If a durable report or web-report source document is required, run the report composition pass:
...
29. Run source trust review for important source clusters.
30. Run claim verification review for consequential claims.
31. Organize the synthesis into Data, Information, Knowledge, and Insight when the research supports a planning decision.
32. Analyze causes, mechanisms, patterns, constraints, counterevidence, and practical implications.
33. Record why the loop stopped.
34. Produce findings, implications, next research actions, and the next best user question if further depth would help.
35. Produce the full-depth Markdown research report at market-intelligence / corporate research standard.
36. If the user requested a webpage, stop after the research/report handoff and route HTML implementation to `web-builder`; do not build the web page inside deep-dive-researcher.
37. Save durable research artifacts under `workspace/projects/<project-slug>/research/`.
38. Suggest memory updates only for reusable, evidence-backed patterns.
